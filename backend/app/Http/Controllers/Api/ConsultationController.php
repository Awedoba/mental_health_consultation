...
class ConsultationController extends ApiController
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validator = Validator::make($request->all(), [
            ...
            'personal_history' => 'nullable|string|max:2000',
            'occupational_marital_history' => 'nullable|string|max:2000',
            'substance_abuse_history' => 'nullable|string|max:2000',
        ...
        $consultation = Consultation::create([
            ...
            'occupational_marital_history' => $request->occupational_marital_history,
            'substance_abuse_history' => $request->substance_abuse_history,
